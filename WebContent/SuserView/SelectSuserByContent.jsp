...
<table bgcolor="dddddd" border="1" width="100%" height="60px"><tr>
<td align="center">按
...
String selectdevice=request.getParameter("selectdevice");
			...
			if(selectdevice.equals("userId")){
				sList=mud.selectSuserByUserId(content);
            }else if(selectdevice.equals("name")){
            	sList=mud.selectSuserByName(content);
            }else if(selectdevice.equals("phone")){
            	sList=mud.selectSuserByPhone(content);
            }
			if(sList.size()!=0){
