...
<td align="right"><font color=white>用户：<%=name %>	  |   </font>	
<a href="login.jsp"><font color=white>退出	|	</font></a></td>
</tr></table>
<table width="100%" height="760px"><tr>
<td width="20%" height="100%"><iframe src="left.jsp" width="100%" height="100%" frameborder="0"></iframe></td>
