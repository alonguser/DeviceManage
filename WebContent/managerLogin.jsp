...
<body>
	<div class="login">
		<h1>管理后台登录</h1>
		<form action="CheckManageLoginServlet" method="post">
			...
			<table align="center" width="100%"><tr align="center"><td align="center"><a href="login.jsp"><font color=red>是学生账号？去学生登录</font></a></td></tr></table>
		</form>
	</div>
