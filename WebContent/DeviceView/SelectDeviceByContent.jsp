...
<% request.setCharacterEncoding("utf-8");
 ...
 String selectdevice=request.getParameter("selectdevice");
            ...
            if(selectdevice.equals("name")){
            	devList=dd.selectDeviceByName(content);
            }else if(selectdevice.equals("location")){
            	devList=dd.selectDeviceByLocation(content);
            }else if(selectdevice.equals("address")){
            	devList=dd.selectDeviceByAddress(content);
            }else if(selectdevice.equals("repair")){
            	devList=dd.selectDeviceByRepair(content);
            }else if(selectdevice.equals("time")){
            	devList=dd.selectDeviceByTime(content);
            }
			if(devList.size()!=0){
